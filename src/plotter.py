...
def plotMov(nCells,nTimeStep,sol):
    ...
    fig = plt.figure()
    ax = plt.axes(xlim=(0, nCells-1),ylim = (-3,3))
    line, = ax.plot([], [], lw=2)
...
def OVSNC():
    ...
    '''
    axs[0, 0].plot([np.log(10/n) for n in [8,16,32,64,128,256,512,1024]],[np.log(val) for val in ovsdata[2]], 'tab:green',marker=".")
    ...
    axs[0, 1].plot([np.log(10/n) for n in [8,16,32,64,128,256,512,1024]],[np.log(val) for val in ovsdata[3]], 'tab:orange',marker=".")
    ...
    axs[1, 0].plot([np.log(10/n) for n in [16,32,64,128,256,512,1024]],y ,'tab:green',marker=".")
    ...
    axs[1, 1].plot([np.log(10/n) for n in [16,32,64,128,256,512,1024]],y2, 'tab:orange',marker=".")
    ...
    axs[0, 0].plot([np.log(10/n) for n in [8,16,32,64,128,256,512,1024]],[np.log(val) for val in ovsdata[0]], 'tab:green',marker=".")
    axs[0, 0].set_title('L1 norm for Tf, n = 4, Pe = 1000')
    axs[0, 0].set_ylabel('Log(E)')
    axs[0, 0].set_xlabel('Log(h)')
    axs[0, 0].set_ylim([-8,10])

    axs[0, 1].plot([np.log(10/n) for n in [8,16,32,64,128,256,512,1024]],[np.log(val) for val in ovsdata[1]], 'tab:orange',marker=".")
    axs[0, 1].set_title('Linf norm for Tf, n = 4, Pe = 1000')
    axs[0, 1].set_ylabel('Log(E)')
    axs[0, 1].set_xlabel('Log(h)')
    axs[0, 1].set_ylim([-8,10])
